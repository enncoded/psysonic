export const settings = {
  ...
  streamQualityPerAddressDesc: 'Ask Navidrome to transcode the live stream down to a bitrate cap — useful on slow or remote connections. Set per address: a LAN endpoint and a public proxy can use different caps; playback uses the setting of the address currently connected. Only affects streaming — offline and cached tracks always play at their original quality.',
  streamQualityOriginal: 'No bitrate cap',
  streamQualityKbps: '{{kbps}} kbps',
  streamFormatLabel: 'Transcode format',
  ...
  coverSourceSectionTitle: 'Album artwork',
  coverSourceTitle: 'Album cover sources',
  coverSourceDesc: 'Where album artwork comes from when the server has none. Ordered top-to-bottom; the first enabled source that returns an image wins. Drag to reorder, or switch a source off to skip it.',
  coverSourceServer: 'Server (album info)',
  coverSourceApple: 'Apple Music',
  coverSourceLastfm: 'Last.fm',
  ...
  aboutContributorsThemes: 'Themes',
  aboutThemeContributorsCount_one: '{{count}} theme',
  aboutThemeContributorsCount_other: '{{count}} themes',
  ...
  autodjOverlapCapTitle: 'Overlap limit',
  autodjOverlapCapDesc: 'Caps how long AutoDJ may overlap tracks. Auto follows content analysis (up to 12 s). Limit sets your own maximum.',
  ...
  pauseResumeFade: 'Pause and resume fade',
  pauseResumeFadeDesc: 'Fade audio out when pausing and back in when resuming.',
  pauseResumeFadeDuration: 'Fade duration',
  pauseResumeFadeSecs: '{{n}} s',
